      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Update Nupco Purches</h3>
          </div> 
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <?php
                   $plant = '';
                  $plant_name = $this->common_model->select_column('plants','name',array('id'=>$user_data[0]->plant));
                  if(!empty($plant_name)){
                     $plant = $plant_name[0]->name;
                  }
                ?>
                 ...
                 <select class="form-control" name="plant">
                   ...
                   <?php foreach ($department_list as $key => $value) { ?>
                    <option value="<?= $value->id;?>" <?php if($plant == $value->name){echo 'selected';}?>><?= $value->name;?></option>
                   <?php } ?>
                 </select>
                  <span class="text-danger"><?php echo form_error('plant'); ?></span>
                </div>
              </div>
            </div>
            <div class="col-md-12">
